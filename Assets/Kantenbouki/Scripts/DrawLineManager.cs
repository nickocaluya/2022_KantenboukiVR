...
public class DrawLineManager : MonoBehaviour {
    ...
    public SteamVR_Action_Vector2 triggerValue;
    ...
    void Update()
    {
        ...
        else if (drawAnnotation.stateDown)
